...
func main() {
	...
	if err := db.AutoMigrate(
		...
		// Automation entities (broadcasts, sequences, campaigns)
		&entities.BroadcastEntity{},
		&entities.SequenceEntity{},
		&entities.SequenceStepEntity{},
		&entities.SequenceEnrollmentEntity{},
		&entities.CampaignEntity{},
		// Billing entities (subscriptions, invoices, usage)
		&entities.SubscriptionEntity{},
		&entities.InvoiceEntity{},
		&entities.UsageMeterEntity{},
		// Project members
		&entities.ProjectMemberEntity{},
	); err != nil {
	...
	log.Println("📝 Creating schema_migrations table and marking as applied...")
	...
	// Create schema_migrations table (required by golang-migrate)
	_, err = conn.Exec(`
	...
	// ⚠️ IMPORTANT: Update this when adding new migration files
	// Latest migration: 000047_create_project_members.up.sql
	latestVersion := 47

	// Insert or update schema_migrations table
	_, err = conn.Exec(`
